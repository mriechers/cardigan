...
Renumbered from '009' during v4.1/sprint-1 rebase onto main (see issue #115).
The chat_sessions table picks up an app_version column from migration 011
before being dropped here — the column is removed with the table.
"""
